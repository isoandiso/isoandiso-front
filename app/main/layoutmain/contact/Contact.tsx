        ...
        <div className='bg-white border-t-2'>
            <div className="max-w-6xl w-11/12 mx-auto flex flex-col lg:flex-row lg:items-center">
                <div className="hidden lg:block pb-8 font-urbanist lg:w-full">
                    <img src="../../../../public/img/building.jpg" alt="" className="w-200 lg:w-140 lg:h-200 object-cover mx-auto" />
                </div>
                            ...
                            <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6"> {/* Adjusted gap-y */}
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-1"> {/* Reduced margin-top */}
                                        ...
                                        />
                                        {errors.nombres && typeof errors.nombres.message === "string" && (
                                ...
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-1"> {/* Reduced margin-top */}
                                        ...
                                        />
                                        {errors.apellidos && typeof errors.apellidos.message === "string" && (
                                ...
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-1"> {/* Reduced margin-top */}
                                        ...
                                        />
                                        {errors.celular && typeof errors.celular.message === "string" && (
                                ...
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-1"> {/* Reduced margin-top */}
                                        ...
                                        {errors.tipo_solicitud && typeof errors.tipo_solicitud.message === "string" && (
                                            <p className="text-red-500 text-sm">{errors.tipo_solicitud.message}</p>
                                        )}
                                ...
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-1"> {/* Reduced margin-top */}
                                        ...
                                        />
                                        {errors.ciudad && typeof errors.ciudad.message === "string" && (
                                ...
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-1"> {/* Reduced margin-top */}
                                        ...
                                        />
                                        {errors.codigo_postal && typeof errors.codigo_postal.message === "string" && (
                                ...
                                <div className="col-span-full">
                                    ...
                                    <div className="mt-1"> {/* Reduced margin-top */}
                                        ...
                                        ></textarea>
                                        {errors.mensaje && typeof errors.mensaje.message === "string" && (
