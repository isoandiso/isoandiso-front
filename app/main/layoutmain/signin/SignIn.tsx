                            ...
                            >
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        ...
                                        onInput={(e) => {
                                            const input = e.target as HTMLInputElement; // Aseguramos que e.target sea un HTMLInputElement
                                            input.value = input.value.replace(/[^0-9]/g, ''); // Reemplaza todo lo que no sea número
