...
import FormPg1 from './registerProps/FormPg1'
import FormPg2 from './registerProps/FormPg2'
import FormPg3 from './registerProps/FormPg3'
import FormPg4 from "./registerProps/FormPg4"
    ...
    const handleSubmit = async (data) => {
        ...
        Object.entries(data).forEach(([key, value]) => {
            if (typeof value === 'string') {
                formData.append(key, value); // Si es una cadena, se agrega como string.
            } else if (value instanceof Blob) {
                formData.append(key, value); // Si es un Blob, se agrega como Blob.
            }
        });        
