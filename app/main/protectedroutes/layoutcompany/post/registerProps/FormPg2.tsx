...
import Map from '../../../../generalcomponents/map/Map'
        ...
        <div className={`${currentPage != 2 ? "hidden" : ""} w-full`}>
            <div className='font-urbanist sm:80'>
                ...
                <div>
                    ...
                    {errors.adress && typeof errors.adress.message === 'string' && (
                    ...
                    <div className='flex flex-col sm:flex-row gap-2 my-3'>
                        <div className="w-full">
                            ...
                            <div className="mt-1">
                                ...
                                {errors.departamento && typeof errors.departamento.message === 'string' && (
                                    <p className="text-red-600">{errors.departamento.message}</p>
                                )}
                            </div>
                        </div>
                        <div className="w-full">
                    ...
                    <div className='flex flex-col sm:flex-row gap-2 my-3'>
                        <div className="w-full">
                            ...
                            <div className="mt-1">
                                ...
                                {errors.distrito && typeof errors.distrito.message === "string" &&(
                        ...
                        <div className="w-full">
                            ...
                            <div className="mt-1">
                                ...
                                {errors.urbanization && typeof errors.urbanization.message === "string" && (
                                    <p className="text-red-600">{errors.urbanization.message}</p>
                                )}
                            </div>
                        </div>
                    </div>
