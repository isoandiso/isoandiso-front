            ...
            <div className="mt-2 font-urbanist">
                <div className='flex flex-col sm:flex-row gap-2 my-3'>
                    ...
                    <div className="w-full">
                        ...
                        {errors.bedrooms_number && typeof errors.bedrooms_number.message === "string" && (
                            <p className="text-red-600">{errors.bedrooms_number.message}</p>
                        )}
                    </div>
                </div>
                <div className='flex flex-col sm:flex-row gap-2 my-3'>
                    <div className="w-full">
                        ...
                        {errors.garages_number && typeof errors.garages_number.message === "string" && (
                            <p className="text-red-600">{errors.garages_number.message}</p>
                        )}
                    </div>
                    <div className="w-full">
                        <label
                        ...
                        {errors.bathrooms_number && typeof errors.bathrooms_number.message === "string" && (
                            <p className="text-red-600">{errors.bathrooms_number.message}</p>
                        )}
                    </div>
                </div>
                <div className='flex flex-col sm:flex-row gap-2 my-3'>
                    <div className="w-full">
                        ...
                        {errors.kitchens_number && typeof errors.kitchens_number.message === "string" && (
                            <p className="text-red-600">{errors.kitchens_number.message}</p>
                        )}
                    </div>
                    <div className="w-full">
                        <label
                        ...
                        {errors.floors_number && typeof errors.floors_number.message === "string" && (
                            <p className="text-red-600">{errors.floors_number.message}</p>
                        )}
                    </div>
                </div>
                <div className='flex flex-col sm:flex-row gap-2 my-3'>
                    <div className="w-full font-urbanist">
                        <div className="w-full">
                            ...
                            <div className="mt-1">
                                ...
                                {errors.type_currency && typeof errors.type_currency.message === "string" && (
                                    <p className="text-red-600">{errors.type_currency.message}</p>
                                )}
                            </div>
                        </div>
                    </div>
