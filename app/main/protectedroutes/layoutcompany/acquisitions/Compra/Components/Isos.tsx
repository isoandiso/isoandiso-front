...
export default function Isos(props){
    const {company,setSelectedIsos,selectedIsos,selectedCountry} = props;
                                ...
                                return <div key={index}>
                                            {
                                                ...
                                                company.acquisitionIds?.some(acquisition=>acquisition.isoIds.some(acquiredIso=>acquiredIso._id===iso._id))
                                                ?
