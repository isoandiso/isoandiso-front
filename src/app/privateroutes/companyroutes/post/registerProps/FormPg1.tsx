            ...
            <div className="font-urbanist">
                ...
                <div className='flex flex-col sm:flex-row gap-2'>
                    <div className="sm:w-1/2">
                        ...
                        {errors.type_property && typeof errors.type_property.message === 'string' && (
                        <p className="text-red-600">{errors.type_property.message}</p>
                        )}
                    </div>
                    <div className="sm:w-1/2">
                        ...
                        {errors.subtype_property && typeof errors.subtype_property.message === 'string' && (
                        <span className="text-red-500 text-sm">{errors.subtype_property.message}</span>
                        )}
                    </div>
                </div>
                <div className="my-6 ">
                    ...
                    <div className='flex flex-col sm:flex-row gap-2 mb-3'>
                        <div className="w-full">
                            ...
                            {errors.dni && typeof errors.dni.message === 'string' && (
